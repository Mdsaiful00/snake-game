...
function update() {
    ...
    if (gameOver) {
        ...
        createText(`You Are Ultra Boot`, board.width / 2, board.height / 2 - 25, 'center', 50);
    ...
    // Create first food
    createRect(foodX, foodY, blockSize, blockSize, "cyan");
    ...
    createRect(snakeX, snakeY, blockSize, blockSize, 'red');
